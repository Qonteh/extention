...
def create_second_window():
    ...
    generate_button=tk.Button(second_window,text="GANERATE",bg="#333",fg="#ffffff")
    generate_button.grid(row=7,column=1,pady=20)
    

    # Labels for images
    image1_label = tk.Label(second_window)
    image1_label.grid(row=3, column=0, padx=20, pady=10)
    ...
    image2_label.grid(row=3, column=1, padx=20, pady=10)
    ...
    image3_label.grid(row=3, column=2, padx=20, pady=10)
    ...
    image4_label.grid(row=5, column=0, padx=20, pady=10)
    ...
    image5_label.grid(row=5, column=1, padx=20, pady=10)
    ...
    image6_label.grid(row=5, column=2, padx=20, pady=10)
    ...
    image5_label = Image.open("logo.png")
